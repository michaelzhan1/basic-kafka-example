# compiler
CXX := g++
CXXFLAGS := -std=c++20 -O2 -Wall -Wextra -Wunused-variable -Werror -Iinclude -Isrc/common -MMD -MP
...
DEPS := $(COMMON_CORE_OBJS:.o=.d) $(DB_OBJS:.o=.d) $(PRODUCER_OBJS:.o=.d) $(CONSUMER_OBJS:.o=.d) $(SERVER_OBJS:.o=.d)
...
# include dependency files when present
-include $(DEPS)
